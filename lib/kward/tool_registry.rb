    ...
    def read_file_schema
      {
        ...
        function: {
          name: "read_file",
          description: "Read a text file inside the current workspace. Output is truncated to 2000 lines or 50KB, whichever is hit first. Use offset/limit to continue through large files.",
          parameters: {
            type: "object",
            properties: {
