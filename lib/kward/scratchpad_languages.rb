...
module Kward
  ...
  module ScratchpadLanguages
    LANGUAGES = {
      ...
      crystal: { aliases: %w[crystal cr], display_path: "scratchpad.cr" },
      elixir: { aliases: %w[elixir ex exs], display_path: "scratchpad.ex" },
      julia: { aliases: %w[julia jl], display_path: "scratchpad.jl" },
      javascript: { aliases: %w[javascript js jsx mjs cjs], display_path: "scratchpad.js" },
      typescript: { aliases: %w[typescript ts tsx], display_path: "scratchpad.ts" },
      ...
      shell: { aliases: %w[shell sh bash zsh fish], display_path: "scratchpad.sh" },
      ...
      python: { aliases: %w[python py pyw], display_path: "scratchpad.py" },
      go: { aliases: %w[go], display_path: "scratchpad.go" },
      ...
      swift: { aliases: %w[swift], display_path: "scratchpad.swift" },
      kotlin: { aliases: %w[kotlin kt kts], display_path: "scratchpad.kt" },
      lua: { aliases: %w[lua], display_path: "scratchpad.lua" },
