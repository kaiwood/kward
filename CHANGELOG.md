...
- Added shell-agent model and reasoning-effort settings under `shell.agent` in the main JSON config, with `KWSH_MODE` and `KWSH_REASONING` environment overrides.
