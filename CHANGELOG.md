...
- Changed large tool results to be compacted before they enter model context while preserving full originals in session tool-execution records, and avoided storing retrieval artifacts for outputs that stay verbatim.
